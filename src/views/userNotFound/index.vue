<template>
  <div class="weui_msg">
    ...
    <div class="weui_icon_area"><i class="iconfont icon-ku"></i></div>
    <div class="weui_text_area">
      <p class="info">{{info}}</p>
    </div>
    <!--<p class="info">用户信息过期,请重新登录...</p>-->
<!--    <p class="reLogin" @click="reLogin">重新登录</p>-->
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      reLogin() {
        ...
        window.location.href = `${url.split('/')[0]}//${url.split('/')[2]}/${url.split('/')[3]}/`
      }
    },
  }
</script>
