<template>
  ...
  <div class="table tableHead">
    <table border="0" cellspacing="0" cellpadding="0" rules="groups">
      <tbody>
      <tr>
        <!--<td width="24%" style="height: 30px;">任务名称</td>-->
        <!--<td width="22%" style="height: 30px;">开始时间</td>-->
        <!--<td width="22%" style="height: 30px;">结束时间</td>-->
        <!--<td width="16%" style="height: 30px;">指标金额</td>-->
        <!--<td width="18%" style="height: 30px;">是否完成</td>-->
        <td width="25%" style="height: 30px;">任务名称</td>
        <td width="25%" style="height: 30px;">任务年月</td>
        <td width="25%" style="height: 30px;">指标金额</td>
...
import { perTask, deletePerTask, modifyStoreTask } from '@/api/work';
